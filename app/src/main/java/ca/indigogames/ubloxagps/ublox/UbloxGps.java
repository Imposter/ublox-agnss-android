...
public class UbloxGps {
    public interface ReceiveCallback {
        void onUbxMessage(UByte classId, UByte messageId, BinaryStream dataStream);
        void onNmeaMessage(String prefixId, String messageId, List<String> data);
    }
    ...
    public void handle() throws Exception {
        ...
        if (b.equals(UBX_PROTO_HEADER_B1)) {
            ...
            // TODO: Handle
            if (mReceiveCallback != null)
                mReceiveCallback.onNmeaMessage(prefix, message, data);
        }
